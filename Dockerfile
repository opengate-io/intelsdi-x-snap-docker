...
COPY conf/config.json /opt/snap/conf/cfg.json
...
CMD /usr/local/bin/init_snap && /opt/snap/sbin/snapteld --config /opt/snap/conf/cfg.json -t ${SNAP_TRUST_LEVEL} -l ${SNAP_LOG_LEVEL} -o ''
